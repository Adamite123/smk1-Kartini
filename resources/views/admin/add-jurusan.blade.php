...
<div class="container-fluid pt-4 px-4">
    <div class="row g-4">
                    ...
                    <div>
                        ...
                        @if ($errors->has('image'))
                            <div class="alert alert-danger">
                                @if ($errors->first('image') == ("The image failed to upload."))
                                    Maksimal Gambar adalah 2MB.
                                @else
                                    {{ $errors->first('image') }}
                                @endif  
                            </div>
        ...
        <div class="col-sm-12 col-xl-6">
            <div class="bg-light rounded h-100 p-4">
                <h6 class="mb-4">Jurusan Yang Sudah Ada</h6>
        
                <div class="row">
                    @foreach ($jurusanData as $jurusan)
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <img src="{{ asset($jurusan->image) }}" class="card-img-top custom-card-img" alt="Jurusan Image">
                            <div class="card-body">
                                <h5 class="card-title" style="text-align:center">{{ $jurusan->judul }}</h5>
                                <div class="d-flex justify-content-between align-items-center">
                                    <!-- Edit Icon -->
                                    <a href="{{ route('edit-jurusan', ['id' => $jurusan->id]) }}">
                                        <i class="fas fa-pencil-alt"></i>
                                    </a>
                                    <!-- Delete Icon -->
                                    <a href="{{ route('delete-jurusan', ['id' => $jurusan->id]) }}">
