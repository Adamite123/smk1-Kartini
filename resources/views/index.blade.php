              ...
              <div class="rd-navbar-main-outer">
                <div class="rd-navbar-main">
                  ...
                  <div class="rd-navbar-panel">
                    ...
                    <!-- RD Navbar Brand-->
                    <div class="rd-navbar-brand"><a class="brand" href="index.html"><img src="images/kartini.png" alt="" width="303" height="50"/></a></div>
                  </div>
...
<script src="https://unpkg.com/swiper/swiper-bundle.min.js"></script>
    <script>
      ...
      var swiper = new Swiper('#team-slider', {
          ...
          navigation: {
              nextEl: '.swiper-button-next', // Next button class or ID
              prevEl: '.swiper-button-prev', // Previous button class or ID
              effect: 'fade',
          },
          breakpoints: {
